    ...
    def validate_network_coverage(self) -> Dict:
        ...
        for name, location in test_locations.items():
            try:
                ...
                if nearest_node:
                    node_data = self.road_network.nodes[nearest_node]
            ...
            for j, (name2, loc2) in enumerate(covered_locations):
                if i < j:  # Avoid duplicate tests
                    ...
                    try:
                        ...
                        if node1 and node2:
                            nx.shortest_path(self.road_network, node1, node2)
        ...
        return {
            'network_nodes': len(self.road_network.nodes),
            'network_edges': len(self.road_network.edges),
